<?php /* Smarty version Smarty-3.1.19, created on 2017-11-12 21:14:13
         compiled from "/var/www/takanags.com/public_html/admin453bbuh6d/themes/default/template/controllers/translations/helpers/view/translation_modules.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4370703455a08fff5107f98-05870433%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd23c976ab0606de00510bea151d5c4116046d5ed' => 
    array (
      0 => '/var/www/takanags.com/public_html/admin453bbuh6d/themes/default/template/controllers/translations/helpers/view/translation_modules.tpl',
      1 => 1499040041,
      2 => 'file',
    ),
    '768967662993b2bcb648052561a11beb91824642' => 
    array (
      0 => '/var/www/takanags.com/public_html/admin453bbuh6d/themes/default/template/helpers/view/view.tpl',
      1 => 1499040041,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4370703455a08fff5107f98-05870433',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a08fff5337cc6_53418149',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a08fff5337cc6_53418149')) {function content_5a08fff5337cc6_53418149($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/takanags.com/public_html/vendor/prestashop/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/takanags.com/public_html/vendor/prestashop/smarty/plugins/modifier.regex_replace.php';
?>
...
<br/>
		...
		<?php }?>
		<?php echo smartyTranslate(array('s'=>'%s at least, or you will have to edit the translation files.','sprintf'=>array($_smarty_tpl->tpl_vars['limit_warning']->value['needed_limit'])),$_smarty_tpl);?>
 ...
 <span class="badge"><?php echo smartyTranslate(array('s'=>'%d','sprintf'=>array($_smarty_tpl->tpl_vars['count']->value)),$_smarty_tpl);?>
</span></p>
			<p><?php echo smartyTranslate(array('s'=>'Total missing expressions:'),$_smarty_tpl);?>
 <span class="badge"><?php echo smartyTranslate(array('s'=>'%d','sprintf'=>array($_smarty_tpl->tpl_vars['missing_translations']->value)),$_smarty_tpl);?>
</p>
		</div>

		<form method="post" id="<?php echo $_smarty_tpl->tpl_vars['table']->value;?>
_form" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['url_submit']->value,'html','UTF-8');?>
...
" />
				<div id="BoxUseSpecialSyntax">
					<div class="alert alert-warning">
						<p>
							<?php echo smartyTranslate(array('s'=>'Some of these expressions use this special syntax: %s.','sprintf'=>array('%d')),$_smarty_tpl);?>
						...
						<ul>
							<li>"<?php echo smartyTranslate(array('s'=>'There are [1]%replace%[/1] products','html'=>true,'sprintf'=>array('%replace%'=>'%d','[1]'=>'<strong>','[/1]'=>'</strong>')),$_smarty_tpl);?>
": <?php echo smartyTranslate(array('s'=>'"%s" will be replaced by a number.','sprintf'=>array('%d')),$_smarty_tpl);?>
</li>
							<li>"<?php echo smartyTranslate(array('s'=>'List of pages in [1]%replace%[/1]','html'=>true,'sprintf'=>array('%replace%'=>'%s','[1]'=>'<strong>','[/1]'=>'</strong>')),$_smarty_tpl);?>
": <?php echo smartyTranslate(array('s'=>'"%s" will be replaced by a string.','sprintf'=>array('%s')),$_smarty_tpl);?>
</li>
							<li>"<?php echo smartyTranslate(array('s'=>'Feature: [1]%1%[/1] ([1]%2%[/1] values)','html'=>true,'sprintf'=>array('%1%'=>'%1$s','%2%'=>'%2$d','[1]'=>'<strong>','[/1]'=>'</strong>')),$_smarty_tpl);?>
...
" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['cancel_url']->value,'html','UTF-8');?>
...
" class="btn btn-default pull-right"><i class="process-icon-save"></i> <?php echo smartyTranslate(array('s'=>'Save','d'=>'Admin.Actions'),$_smarty_tpl);?>
</button>
					<button type="submit" id="<?php echo $_smarty_tpl->tpl_vars['table']->value;?>
_form_submit_btn" name="submitTranslations<?php echo ucfirst($_smarty_tpl->tpl_vars['type']->value);?>
AndStay" class="btn btn-default pull-right"><i class="process-icon-save"></i> <?php echo smartyTranslate(array('s'=>'Save and stay','d'=>'Admin.Actions'),$_smarty_tpl);?>
</button>
				</div>
			</div>

			<?php  $_smarty_tpl->tpl_vars['selected_theme'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['selected_theme']->_loop = false;
...
foreach ($_from as $_smarty_tpl->tpl_vars['selected_theme']->key => $_smarty_tpl->tpl_vars['selected_theme']->value) {
$_smarty_tpl->tpl_vars['selected_theme']->_loop = true;
 $_smarty_tpl->tpl_vars['theme_name']->value = $_smarty_tpl->tpl_vars['selected_theme']->key;
?>
...
"><?php echo $_smarty_tpl->tpl_vars['theme_name']->value;?>
 ...
 $_from = $_smarty_tpl->tpl_vars['selected_theme']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" />
								...
								<div class="panel-footer">
									<a name="submitTranslations<?php echo ucfirst($_smarty_tpl->tpl_vars['type']->value);?>
" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['cancel_url']->value,'html','UTF-8');?>
" class="btn btn-default"><i class="process-icon-cancel"></i> <?php echo smartyTranslate(array('s'=>'Cancel','d'=>'Admin.Actions'),$_smarty_tpl);?>
</a>
									<button type="submit" id="<?php echo $_smarty_tpl->tpl_vars['table']->value;?>
_form_submit_btn" name="submitTranslations<?php echo ucfirst($_smarty_tpl->tpl_vars['type']->value);?>
" class="btn btn-default pull-right"><i class="process-icon-save"></i> <?php echo smartyTranslate(array('s'=>'Save','d'=>'Admin.Actions'),$_smarty_tpl);?>
...
AndStay" class="btn btn-default pull-right"><i class="process-icon-save"></i> <?php echo smartyTranslate(array('s'=>'Save and stay','d'=>'Admin.Actions'),$_smarty_tpl);?>
    ...
    <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['url_submit_installed_module']->value,'html','UTF-8');?>
...
" />
        ...
        <p class="alert alert-info">
          <?php echo smartyTranslate(array('s'=>'Here you can modify translations for all installed module.'),$_smarty_tpl);?>
<br />
        </p>
        <div class="form-group">
          <label class="control-label col-lg-3" for="translations-languages"><?php echo smartyTranslate(array('s'=>'Select your module'),$_smarty_tpl);?>
</label>
          <div class="col-lg-4">
            <select name="module" id="installed_module">
              <option value=""><?php echo smartyTranslate(array('s'=>'Module'),$_smarty_tpl);?>
</option>
              <?php  $_smarty_tpl->tpl_vars['module'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['module']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['installed_modules']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['module']->key => $_smarty_tpl->tpl_vars['module']->value) {
$_smarty_tpl->tpl_vars['module']->_loop = true;
...
">
            <i class="process-icon-edit"></i> <?php echo smartyTranslate(array('s'=>'Modify translations'),$_smarty_tpl);?>
