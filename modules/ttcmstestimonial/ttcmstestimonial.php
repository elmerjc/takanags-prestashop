...
class Ttcmstestimonial extends Module implements WidgetInterface
{
    ...
    public function installFixtures()
    {
        ...
        $tab_texts = array(
            array(
                'text' => '<div class="tttestimonial-content container">
<div class="customNavigation"></div>
<div class="tttestimonial-inner">
<ul id="tttestimonial-carousel" class="tt-carousel">
<li>
<div class="testimonial-image"><img alt="" src="../img/cms/user1.jpg" /></div>
...
<li>
<div class="testimonial-image"><img alt="" src="../img/cms/user2.jpg" /></div>
<div class="testimonial-content">
<div class="testimonial-user-title">
<h4>John Duff</h4>
<div class="user-designation">SEO and founder</div>
...
<li>
<div class="testimonial-image"><img alt="" src="../img/cms/user3.jpg" /></div>
<div class="testimonial-content">
<div class="testimonial-user-title">
<h4>John Duff</h4>
<div class="user-designation">SEO and founder</div>
