...
class Tt_Brandlogo extends Module implements WidgetInterface
{
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'tt_brandlogo';
        ...
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName = $this->trans('TT - Brand Logo',array(),'Modules.Brandlogo');
        $this->description = $this->trans('Displays Brand logo on homepage.',array(),'Modules.Brandlogo');
        $this->ps_versions_compliancy = array('min' => '1.7.0.0', 'max' => _PS_VERSION_);
        $this->templateFile = 'module:tt_brandlogo/views/templates/hook/tt_brandlogo.tpl';
    }

    public function install()
    {
        Configuration::updateValue('TT_BRAND_NAME', 0);
    ...
    public function uninstall()
    {
        return parent::uninstall()
            && Configuration::deleteByName('TT_BRAND_NAME');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitTTBlockBrandLogos')) {
			...
			Configuration::updateValue('TT_BRAND_NAME', (int)(Tools::getValue('TT_BRAND_NAME')));
			$this->_clearCache('*');
    ...
    {
        return array(
            'TT_BRAND_NAME' => (int)Tools::getValue('TT_BRAND_NAME', Configuration::get('TT_BRAND_NAME')),
        );
    }
    ...
    public function getWidgetVariables(
        ...
        return array(
			...
			'brandname' => Configuration::get('TT_BRAND_NAME'),
    ...
    public function renderWidget(
        ...
        $cacheId = $this->getCacheId('tt_brandlogo');
