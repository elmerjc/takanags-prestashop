...
class Tt_BestSellers extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'tt_bestsellers';
        ...
        $this->displayName = $this->trans('TT - Top-sellers block', array(), 'Modules.Bestsellers.Admin');
        $this->description = $this->trans('Adds a block to display top-selling products.', array(), 'Modules.Bestsellers.Admin');

        $this->templateFile = 'module:tt_bestsellers/views/templates/hook/tt_bestsellers.tpl';
    }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('tt_bestsellers'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('tt_bestsellers'));
    }
