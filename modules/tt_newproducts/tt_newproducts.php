...
class Tt_NewProducts extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'tt_newproducts';
        ...
        $this->displayName = $this->trans('TT - New products block', array(), 'Modules.Newproducts.Admin');
        $this->description = $this->trans('Displays new products on the homepage.', array(), 'Modules.Newproducts.Admin');

        $this->templateFile = 'module:tt_newproducts/views/templates/hook/tt_newproducts.tpl';
    }
    ...
    public function install()
    {
        ...
        return parent::install()
            && Configuration::updateValue('TT_NEW_PRODUCTS_NBR', 10)
    ...
    public function uninstall()
    {
        ...
        if (!parent::uninstall() ||
            !Configuration::deleteByName('TT_NEW_PRODUCTS_NBR')) {
            return false;
        }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitBlockNewProducts')) {
            ...
            $productNbr = Tools::getValue('TT_NEW_PRODUCTS_NBR');
            ...
            if (!$productNbr || empty($productNbr)) {
                ...
                Configuration::updateValue('TT_NEW_PRODUCTS_NBR', (int)$productNbr);
    ...
    public function getConfigFieldsValues()
    {
        return array(
            ...
            'TT_NEW_PRODUCTS_NBR' => Tools::getValue('TT_NEW_PRODUCTS_NBR', Configuration::get('TT_NEW_PRODUCTS_NBR')),
        );
    }

    public function renderWidget($hookName, array $configuration)
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('tt_newproducts'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('tt_newproducts'));
    }
    ...
    protected function getNewProducts()
    {
        ...
        if (Configuration::get('PS_NB_DAYS_NEW_PRODUCT')) {
            $newProducts = Product::getNewProducts(
                ...
                0,
                (int)Configuration::get('TT_NEW_PRODUCTS_NBR')
            );
        }
