...
{	
	...
	public function hookDisplayTtproductImageHover($params) {
			...
			if (!$this->isCached('tt_productimagehover.tpl', $this->getCacheId($params['id_product']))) {
		...
		return $this->display(__FILE__, 'tt_productimagehover.tpl', $this->getCacheId($params['id_product']));
	}
}