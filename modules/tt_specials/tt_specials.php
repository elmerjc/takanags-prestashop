...
class Tt_Specials extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'tt_specials';
        ...
        $this->displayName = $this->trans('TT - Specials block', array(), 'Modules.Specials.Admin');
        ...
        $this->templateFile = 'module:tt_specials/views/templates/hook/tt_specials.tpl';
    }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('tt_specials'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('tt_specials'));
    }
